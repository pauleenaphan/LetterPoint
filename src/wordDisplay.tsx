...
export default function WordDisplay() {
  ...
  return (
    <div className="flex flex-col h-screen p-8">
      <h1 className="text-4xl font-bold text-center">Letter Point</h1>
      <p className="text-lg text-center mb-8 text-gray-500">Insert your words, calculate the points, and see your total score</p>

      <div className="flex-1 w-full max-w-4xl mx-auto flex flex-col min-h-0">
        <div className="flex justify-between items-center gap-4">
          <h2 className="text-2xl font-semibold">Your Words</h2>
        ...
        <div className="mt-4 p-4 bg-gray-100 rounded text-right flex-shrink-0">
          <span className="text-xl"><span className="font-bold">Total:</span> {totalPoints}</span>
        </div>
      </div>

      <div className="mt-8 w-full max-w-4xl mx-auto mb-8">
        <div className="flex gap-2">
          <input 
            ...
            className="px-4 py-2 border rounded text-lg flex-1"  
          />
          <button onClick={addWord} className="px-6 py-2 bg-blue-700 text-white rounded hover:bg-blue-600 whitespace-nowrap cursor-pointer">
            Add 
          </button>
          <button onClick={clearAll} className="px-6 py-2 bg-red-700 text-white rounded hover:bg-red-600 whitespace-nowrap cursor-pointer">
            Clear 
          </button>
        </div>
      </div>
